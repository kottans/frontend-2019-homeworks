class Menu{
    constructor(){
        ...
        this.init();
     this.data = {
         HTML: "Hyper Text Markup Language (HTML) is the backbone of any website development process, without" +
             " which a web page doesn't exist. Hypertext means that text has links, termed hyperlinks, embedded " +
             "in it. When a user clicks on a word or a phrase that has a hyperlink, it will bring another web-page." +
             " A markup language indicates text can be turned into images, tables, links, and other representations." +
             " It is the HTML code that provides an overall framework of how the site will look. HTML was developed" +
             " by Tim Berners-Lee. The latest version of HTML is called HTML5 and was published on October 28, " +
             "2014 by the W3 recommendation. This version contains new and efficient ways of handling elements " +
             "such as video and audio files.",
         CSS: "Cascading Style Sheets (CSS) controls the presentation aspect of the site and allows your site to" +
         ...
         JS:"JavaScript is an event-based imperative programming language (as opposed to HTML's declarative language" +
             " model) that is used to transform a static HTML page into a dynamic interface. JavaScript code can use" +
             " the Document Object Model (DOM), provided by the HTML standard, to manipulate a web page in response " +
             "to events, like user input.\n" +
