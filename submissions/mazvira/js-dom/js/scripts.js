...
main.innerHTML = phones[0].info + phones[0].img;

ul.addEventListener('click', function(e) {
var phone = phones.find(obj => obj.name === e.target.textContent);
main.innerHTML = phone.info + phone.img;
