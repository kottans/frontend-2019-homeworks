...
Creature.prototype.addFriends = function(...friends){
...
man.addFriends(women, dog);
women.addFriends(man, cat);
cat.addFriends(women, catWomen);
dog.addFriends(man);
catWomen.addFriends(cat);
function getPrintableInfo(obj){
    return obj.species + ';' + obj.name + ';' + obj.hands + ';' + obj.legs + ';' + obj.gender + ';' + obj.phrase + ';' + obj.friendList;
}
// ======== OUTPUT ========
print(getPrintableInfo(man));
print(getPrintableInfo(women));
print(getPrintableInfo(dog));
print(getPrintableInfo(cat));
print(getPrintableInfo(catWomen));
